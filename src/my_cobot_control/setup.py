...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'urdf', 'mycobot_280_pi'), 
            glob('urdf/mycobot_280_pi/*.urdf')),
        (os.path.join('share', package_name, 'urdf', 'adaptive_gripper'), 
            glob('urdf/adaptive_gripper/*.urdf')),
        (os.path.join('share', package_name, 'urdf', 'mycobot_280_pi', 'meshes'),
            glob('urdf/mycobot_280_pi/meshes/**/*', recursive=True)),
    ],
